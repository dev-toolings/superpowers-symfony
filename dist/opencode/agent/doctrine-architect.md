---
description: Designs Doctrine entity schemas, relationships, and migration strategies. Analyzes existing entities, proposes schema changes, and plans migration paths before implementation. Use for entity design, relationship modeling, or migration planning.
mode: subagent
tools:
  write: false
  edit: false
...
- `content/skills/doctrine-migrations/SKILL.md`
- `content/skills/doctrine-transactions/SKILL.md`
