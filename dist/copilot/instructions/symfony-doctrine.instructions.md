---
applyTo: "src/Entity/**,src/Repository/**,migrations/**,config/packages/doctrine.yaml"
description: Entity mapping, relations, migrations, transactions, fetch modes, batch processing and lifecycle events.
---

<!-- @generated by scripts/build.ts from content/ — DO NOT EDIT -->
# Doctrine ORM

Entity mapping, relations, migrations, transactions, fetch modes, batch processing and lifecycle events.
...
- **doctrine-transactions** — Handle Doctrine transactions (ORM 3 wrapInTransaction), optimistic/pessimistic locking, flush strategies, and transaction boundaries
  Open `content/skills/doctrine-transactions/SKILL.md`.
